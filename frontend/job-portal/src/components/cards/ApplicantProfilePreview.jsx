...
const ApplicantProfilePreview = ({selectedApplicant,setSelectedApplicant,handleDownloadResume,handleClose}) => {

    const [currenStatus,setCurrentStatus]=useState(selectedApplicant.status);
                ...
                <div className='bg-gray-50 rounded-lg p-4'>
                    ...
                    <div className='space-y-2'>
                        <div className='flex justify-between'>
                            ...
                            <StatusBadge status={currenStatus}/>
                        </div>
                        <div className='flex justify-between'>
                            <span className='text-gray-600'>Applied Date:</span>
                            <span className='text-gray-900'>{moment(selectedApplicant.createdAt)?.format('Do MM YYYY')}</span>
                        </div>
                    </div>
                </div>
                <button
