    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-4xl mx-auto'>
        ...
        <div className=''>
          ...
          <div className='relative bg-white px-0 mt-8 border-b border-gray-100'>
            <div className='relative z-10'>
              <div className='flex items-start justify-between mb-0'>
                ...
                {user?.companyLogo ? (
                  <img
                    className='w-16 h-16 md:h-20 md:w-20 rounded-2xl border-4 border-white/20 shadow-lg '
              ...
              {/*tags*/}
              <div className='flex flex-wrap gap-3 mt-6 mb-8 md:mt-0'>
                ...
                <div className='flex items-center space-x-1 px-4 py-2 bg-gray-50 text-sm text-gray-700 font-semibold'>
          ...
          <div className='px-0 pb-8 space-y-8'>
            ...
            <div className='relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl '>
              ...
              <div className='space-y-4'>
                ...
                <div className='bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 rounded-xl pl-6'>
                  <div className='text-sm text-gray-700 leading-relaxed whitespace-pre-wrap'>
