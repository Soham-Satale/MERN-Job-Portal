...
const ManageJobs = () => {
  ...
  const[sortDirection,setSortDirection]=useState('asc');//a->z
  ...
  const SortIcon=({field})=>{
    ...
    return sortDirection==='asc'?<ChevronDown className='w-4 h-4 text=blue-400'/>:<ChevronUp className='w-4 h-4 text-blue-400'/>
  }
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='mb-8'>
            <div className='flex flex-row items-center justify-between '>
              ...
              <button
              className='inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-sm rounded-xl shadow-lg hover:shadow-xl transition-all shadow-blue-500/25 hovr:shadow-blue-500/30 duration-300 ease-in-out font-semibold transform hover:-translate-y-0.5 whitespace-nowrap'
                  ...
                  <table className='min-w-full divide-y divide-gray-200'>
                    <thead className='bg-gradient-to-r from-gray-50 to-gray-100/50'>
                      <tr>
                        ...
                        <th
                        className='px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[180px] sm:min-w-0'
                        >
                          Actions
                        </th>
                      </tr>
                      ...
                      >
                        ...
                        <td className='px-6 py-4 whitespace-nowrap text-sm font-medium min-w-[180px] sm:min-w-0'>
                          <div className='flex space-x-2'>
                            ...
                            onClick={()=>navigate('podt-job',{state:{jobId:job.id}})}
                            >
                            ...
                            {job.status==='Active' ? (
                              ...
                              className='flex items-center gap-2 text-xs text-orange-600 hover:text-orange-800  transition-colors duration-200 hover:bg-orange-50 p-2 rounded-lg'
                              >
                                <X className='w-4 h-4'/>
                              ...
                              <button 
                              onClick={()=>handleStatusChange(job.id)}
                              className='flex items-center gap-2 text-xs text-green-600 hover:text-green-800 transition-colors duration-200 hover:bg-green-50 p-2 rounded-lg '
                              >
                ...
                <div className='hidden sm:flex-1 sm:flex sm:items-center sm:justify-between'>
                  <div>
                    <p className='text-sm text-gray-700'>
                      ...
                      <span className='font-medium'>{Math.min(startIndex+itemsPerPage,filteredAndSortedJobs.length)}</span> {' '}
                      of {' '}
