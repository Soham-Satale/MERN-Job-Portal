              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                ...
                <div className='space-y-6'>
                  ...
                  <div>
                    ...
                    className='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-blue-500 focus:border-transparent transition-all'
