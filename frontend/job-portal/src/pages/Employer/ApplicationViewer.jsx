  ...
  return (
    <DashboardLayout activeMenu='manage-jobs'>
      ...
      <div className='min-h-screen bg-gray-50'>
        ...
        {/*Main Content*/}
        <div className='max-w-full mx-auto px-4 sm:px-6 lg:px-0 pb-8'>
          {Object.keys(groupApplications).length===0 ? (
            //Empty state
            ...
            <div className='space-y-8'>
              {Object.values(groupApplications).map(
                ({job,applications})=>(
                  <div
                  key={job._id}
                    ...
                    <div className='p-6'>
                      <div className='space-y-4'>
                        {applications.map((application)=>(
                          <div
                          key={application._id}
                          className='flex flex-cols md:flex-row items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors'
                          >
