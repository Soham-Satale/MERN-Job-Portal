...
const Hero = () => {
    ...
    const stats=[
        {icon:Users, label:'Active Users', value:'1.5M+'},
        {icon:Building2, label:'Companies', value:'50K+'},
        {icon:TrendingUp, label:'Jobs Posted', value:'100K+'}
    ];
  ...
  return (
    <section className='pt-24 pb-16 bg-white min-h-screen flex items-center'>
            ...
            <div className='max-w-4xl mx-auto text-center'>
                ...
                >
                    <motion.button
                        ...
                        className='group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-3'
                    >
        ...
        <div className='absolute inset-0 overflow-hidden pointer-events-none'>
            ...
            <div className='absolute top-1/2 transform translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full blur-3xl opacity-20'></div>
        </div>
    </section>
  )
}
