      ...
      <div className='min-h-screen bg-gray-50 py-8 px-4 mt-16 lg:m-20'>
        <div className='max-w-4xl mx-auto'>
          <div className='bg-white rounded-xl shadow-lg overflow-hidden'>
            {/*Header*/}
            <div className='bg-gradient-to-r from-blue-500 to-blue-600 py-6 px-8 flex items-center justify-between items-center '>
              ...
              <div className='space-y-6'>
                <div className='flex items-center space-x-4'>
                  <div className='relative'>
                    ...
                    />
                    {uploading?.avatar && (
                      <div className='absoulte inset-0 bg-black bg-opacity-50 flex items-center justify-center'>
