      ...
      <div className='min-h-screen mt-16'>
        ...
        <div className='flex gap-6 lg:gap-8'>
              ...
              <div className='hidden lg:block w-80 flex-shrink-0'>
                <div className='bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg shadow-gray-200 border border-white/20 p-6 sticky top-20'>
              ...
              <div className='flex-1 min-w-0'>
                {/*Results Header */}
                <div className='flex flex-col lg:flex-row items-between justify-between mb-6 lg:mb-8 gap-4'>
                  <div>
