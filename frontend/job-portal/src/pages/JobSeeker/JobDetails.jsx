...
const JobDetails = () => {
  ...
  const getJobDetailsById=async()=>{
    try{
      const response=await axiosInstance.get(API_PATHS.JOBS.GET_JOB_BY_ID(jobId),{ params: {userId:user?._id}});
  ...
  return (
    <div className='bg-gradient-to-r from-blue-50 via-white to-purple-50'>
      <Navbar/>
      <div className='container mx-auto pt-24 pl-4 pr-4'>
        {/*Main content card*/}
        {jobDetails && (
              ...
              <div className='relative z-10'>
                <div className='flex items-center gap-3 mb-6'>
                  {jobDetails?.company?.companyLogo ? (
                    ...
                    alt="Company Logo" 
                    className='h-20 w-20 object-cover rounded-2xl border-4 border-white/20 shadow-xl'
                    />
                  ) : (
                ...
                <div className='relative z-10'>
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-3'>
                      <div className='p-3 bg-gradient-to-r from-emerald-500 to-teal-500 border rounded-xl'>
