    ...
    <div className='bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200 border border-white/20 p-4 lg:p-8 mb-6 lg:mb-8 '>
        ...
        <div className='flex flex-col lg:flex-row gap-3 lg:gap-4 mt-4'>
            <div className='flex-1 relative'>
                ...
                className='w-full pl-12 pr-4 py-2 lg:py-2.5 border border-gray-200 rounded-xl lg:rounded-xl text-sm outline-0 text-base bg-white/50 backdrop-blur-sm'
            ...
            <button className='bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 lg:px-10 py-3 lg:py-3.5 rounded-xl lg:rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-200 font-semibold text-base shadow-lg hover:shadow-xl transform hover:-translate-y-0.5'>
                Search Jobs
            </button>
        </div>
    </div>
